        ...
        @import url("https://fonts.googleapis.com/css2?family=Poppins");
          ...
          <g>
            <rect width="${box.width}" height="${box.height}" x="0" y="0" rx="${box.curve}" ry="${box.curve}" 
              style="fill:${background};stroke-width:${box.border};stroke:white" /> 
          <g transform="translate(${box.border * 2}, ${box.border * 2}) scale(0.0625)" dominant-baseline="middle" text-anchor="left">
          ...
          <text x="${box.border * 2 + 96}" y="${box.border * 2 + 32}" font-size= "${box.width / 16}" dominant-baseline="middle" text-anchor="left" font-family="Poppins">
            ${req.query.github}</text>   
          <circle r="${circle.r * 2}" cx="${circle.r * 3}" cy="${circle.r * 4}" style="fill:transparent;stroke-width:${box.border};stroke:white"/>
          <rect x="${circle.r * 6 - line.width / 2}" y = "${circle.r * 2}" width="${line.width}" height="${box.height - circle.r * 3}" rx="${line.width / 2}" ry="${line.width / 2}" fill="white"/>
          ...
          ${link} 
          <circle r="${circle.r}" cx="${circle.r * 3}" cy="${circle.r * 4}" style="fill:${background};stroke-width:${box.border / 2};stroke:white"/>
          <circle r="${circle.r}" cx="${circle.r * 9}" cy="${circle.r * 4}" style="fill:${background};stroke-width:${box.border / 2};stroke:white"/>
        </g>
